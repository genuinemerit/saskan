...
-- GROUP center_from_univ_center_gly: <class 'data_structs.GroupStruct.CoordXYZ'>
...
-- GROUP boundary_gly: <class 'data_structs.GroupStruct.Game3DLoc'>
...
-- GROUP timing_pulsar_loc_gly: <class 'data_structs.GroupStruct.CoordXYZ'>
